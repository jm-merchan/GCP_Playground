...
provider "boundary" {
  addr             = "https://boundary-europe-southwest1-5k2l.josemerchan-6b5afd.gcp.sbx.hashicorpdemo.com"
  tls_insecure     = true
  recovery_kms_hcl = <<EOT
    kms "gcpckms" {
    purpose     = "recovery"
    key_ring    = "kms-boundary-keyring-5k2l"
    crypto_key  = "kms-boundary-key-recovery-5k2l"
