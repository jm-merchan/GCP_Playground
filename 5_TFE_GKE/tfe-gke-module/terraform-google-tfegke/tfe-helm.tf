  ...
  tfe_user_data = templatefile("${path.module}/templates/tfe-values.yaml.tpl",
    {
      ...
      TFE_HOSTNAME                          = "tfe.${data.google_dns_managed_zone.env_dns_zone.dns_name}:5432"
      ...
      TFE_OBJECT_STORAGE_S3_ACCESS_KEY_ID   = google_storage_hmac_key.tfe-s3-access.access_id
      TFE_OBJECT_STORAGE_GOOGLE_CREDENTIALS = google_storage_hmac_key.tfe-s3-access.secret
